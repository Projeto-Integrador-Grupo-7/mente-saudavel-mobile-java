...
public class ResultadoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (contagemSim >= 17) { // 17-20 SIM
            valorDoResultado = 1;
        } else if (contagemSim >= 13) { // 13-16 SIM
            valorDoResultado = 2;
        } else if (contagemSim >= 9) { // 9-12 SIM
            valorDoResultado = 3;
        } else if (contagemSim >= 5) { // 5-8 SIM
            valorDoResultado = 4;
        } else { // 0-4 SIM
            valorDoResultado = 5;
        }
        ...
        if (valorDoResultado == 1) {
            textViewResultadoTitulo.setText("Estado de Pleno Bem-Estar");
            ...
            textViewResultadoTitulo.setText("Bem-Estar em Crescimento");
            ...
            textViewResultadoTitulo.setText("Equilíbrio Necessita de Atenção");
            ...
            textViewResultadoTitulo.setText("Sinal de Alerta para Cuidado");
            ...
            textViewResultadoTitulo.setText("Momento de Procurar Suporte Profissional");
